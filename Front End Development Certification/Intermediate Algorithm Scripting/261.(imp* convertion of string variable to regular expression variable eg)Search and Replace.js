...
//Advanced Code Solution:(with reg exp)(In these code, replacement works for every existense of searched element and casing is done in every letters of replacing element)
function myReplace(str, before, after) {
  var re = new RegExp(before,"gi");
    // create a function that will change the casing of any number of letter in parameter "target"
    // matching parameter "source"
    ...
    // replace "before" with "after" with "before"-casing
    return str.replace(re, applyCasing(before, after));
}

myReplace("AJumped quick Jumped brown fox jumped over the lazy dog", "JumPed", "leaped");
